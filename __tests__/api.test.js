...
describe("GitHubScorerService", () => {
    ...
    beforeEach(() => {
        ...
        require("@octokit/graphql").graphql.defaults.mockReturnValue(
            mockGraphqlClient
        );
    ...
    test("returns cached score when available and fresh", async () => {
        ...
        const result = await githubScorerService.calculateScore(
            "facebook",
            "react"
        );
    ...
    test("handles GitHub API errors", async () => {
        ...
        await expect(
            githubScorerService.calculateScore("nonexistent", "repo")
    ...
    test("validates repository parameters", async () => {
        ...
        await expect(
            githubScorerService.calculateScore("", "repo")
